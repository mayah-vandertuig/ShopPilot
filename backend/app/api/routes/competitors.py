...
from app.analysis.competitors import DISCOVERED_LABEL, build_competitor_detail
...
def get_competitor_detail(analysis_id: int, competitor_id: int, db: Session = Depends(get_db)):
    ...
    detail["competing_listings"] = competitor.competing_listings or detail.get("competing_listings", [])
