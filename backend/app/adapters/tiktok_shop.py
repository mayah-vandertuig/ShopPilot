...
class TikTokShopAdapter(BaseMarketplaceAdapter):
    ...
    not_implemented_message = "TikTok Shop adapter is not fully implemented yet. Using generic extraction fallback."
    ...
    def build_search_url(self, query: str, country: str) -> str:
        return f"https://www.tiktok.com/shop/search?q={query.replace(' ', '+')}"
